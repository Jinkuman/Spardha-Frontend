...
const Card = ({ challenge, toggleExpand, expanded }) => (
  <TouchableOpacity onPress={() => toggleExpand(challenge.id)} style={styles.card}>
    <View style={styles.imge}>
      <View style={styles.userIcon}></View>
      <Text style={styles.userName}>{challenge.author}</Text>
      <Text style={styles.id}>{challenge.id}</Text>
    </View>
    ...
    <View style={styles.socialMedia}>
      <TouchableOpacity>
        <Svg viewBox="0 0 512 512" style={styles.svg}>
      ...
      <TouchableOpacity>
        <Svg viewBox="0 0 448 512" style={styles.svg}>
